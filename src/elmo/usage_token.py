...
datadir = os.path.join('/u/zhigwang/zhigwang1/pycham_workspace/MPCM2/src/elmo/tests', 'fixtures', 'model')
...
sent_embeddings = bilm(context_token_ids)['lm_embeddings'] # [batch_size, 3, sent_length, lm_dim]
...
with tf.Session() as sess:
    ...
    elmo_context_input_, elmo_question_input_, sent_embeddings = sess.run(
        # [elmo_context_input['weighted_op'], elmo_question_input['weighted_op']],
        [context_embeddings_op['lm_embeddings'], elmo_question_input['weighted_op'], sent_embeddings],
